...
$newName = Read-Host -prompt "Input the server name (HV0, HV1, etc...)"	$newName = Read-Host -prompt "Input the server name (HV0, HV1, etc...)"
Rename-Computer -newName $newName	Rename-Computer -newName $newName
